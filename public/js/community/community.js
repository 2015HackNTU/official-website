...
app.controller('communityCtrl', ['$scope', function ($scope) {
	...
	$scope.tags = [
		//Timeline tags here
		{date:'3/7,', picname:'activity-1', left: '160', background:'#BF1920'},//workshop
		{date:'3/28', picname:'activity-2', left: '230', background:'#ED8216'},//meetup
		{date:'5/3', picname:'activity-3', left: '400', background:'#BF1920'},//workshop
		{date:'5/28', picname:'activity-4', left: '480', background:'#ED8216'}//meetup
	];
